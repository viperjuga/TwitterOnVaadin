package com.screen.blockedusers;
 ...
 */
public class BlockedUsers extends VerticalLayout implements View {
    ...
    private CustomLayout createTwitterUsersLayout(){
        ...
        try {
            customLayout = new CustomLayout(getClass().getResourceAsStream("BlockedUsers.html"));
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    private Table createTable(){
        ...
        try {
            mUsers = proxy.requestGetBlockedUsers(mCurrentUser.getId());
